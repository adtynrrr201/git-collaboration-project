# Git Collaboration Project - Organized Structure
...
### For Developers
1. Review the [CONTRIBUTING.md](docs/guides/CONTRIBUTING.md) guidelines
2. Check the [PULL_REQUEST_TEMPLATE.md](docs/templates/PULL_REQUEST_TEMPLATE.md) for PR process
3. Explore the source code in the [src/](src/) directory

### For Documentation Review
- [Git Collaboration Practices](docs/guides/GIT_COLLABORATION_PRACTICES.md) - Overview of practices demonstrated
- [English Report](docs/reports/GIT_COLLABORATION_REPORT_EN.md) - Detailed English report
- [Indonesian Report](docs/reports/LAPORAN_KOLABORASI_GIT.md) - Detailed Indonesian report

## 🤝 Contributing

Please read [CONTRIBUTING.md](docs/guides/CONTRIBUTING.md) for guidelines on how to contribute to this project.
